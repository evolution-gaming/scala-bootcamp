...
| 11-03     | **Effects** - Cats Effect IO, `Fiber`-s                                                                    | [@jurisk](https://github.com/jurisk) & [@Kvitral](https://github.com/Kvitral) | [Effects](src/main/scala/com/evolutiongaming/bootcamp/effects/Effects.scala) ([t](src/test/scala/com/evolutiongaming/bootcamp/effects/EffectsSpec.scala))                                                                                                                                                                                  |
| 11-05     | **Shared State in FP** - Using `Ref`-s and `MVar`-s                                                        | [@Kvitral](https://github.com/Kvitral) & [@jurisk](https://github.com/jurisk) |                                                                                                                                                                                                                                                                                                                                            |
