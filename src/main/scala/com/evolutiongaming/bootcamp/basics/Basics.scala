...
object Basics {
  ...
  val stringLength: String => Int = (s: String) => /* implement here */ s.length
  ...
  val allOptionBooleans: Set[Option[Boolean]] = Set(Some(true), Some(false), Option.empty)
  ...
  val allTupleBooleanBooleans: Set[(Boolean, Boolean)] = Set((true, false), (false, true), (true, true), (false, false))
