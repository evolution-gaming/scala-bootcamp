...
object CirceExercisesSpec {
  private val ex1Expected = """{"title":"The Matrix","year":1999,"actors":["Keanu Reeves","Carrie-Anne Moss","Laurence Fishburn"],"isRatedR":true}"""
  ...
  private val ex4AlbumSongs2 = root.songs.each.string
